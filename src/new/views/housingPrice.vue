...
.searchInput {
    width: 100%;
    height: 0.75rem;
    line-height: .7rem; // background: red;
    ...
    //     top: 0.3rem;
    //     height: 1.5rem;
    //     background: url(../../static/img/sousuo.png) no-repeat;
    //     background-size: 56%;
    //     background-position: center;
    // }
}
...
<template>
       <div  class="fixContent" >
        ...
        <!--区域部分  -->
        <div class="regloin" :class="{'regloin1':AndroidTop,'regloin2':apTop}" v-show="quyu">
            <ul>
        ...
        <!--价格部分  -->
        <div class="regloin" :class="{'regloin1':AndroidTop,'regloin2':apTop}" v-show="jiage">
            <ul>
        ...
        <!--户型筛选部分  -->
        <div class="regloin" :class="{'regloin1':AndroidTop,'regloin2':apTop}" v-show="huxing">
            <ul>
        ...
        <!--更多部分  -->
         <div class="regloin reglogins" :class="{'regloin1':AndroidTop,'regloin2':apTop}" v-show="gengduo">
        ...
        <!--楼盘列表  -->
        <template>
            <builds @receive='deal' :child='searchArr' :fjStatus='true'></builds>
        </template>
        <!-- 遮罩层 -->
...
<script>
import builds from '../components/build1'
