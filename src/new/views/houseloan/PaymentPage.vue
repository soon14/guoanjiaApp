<template>
  ...
  <div class="outerLayerDiv fixContent">
    <div style="margin:0 auto;width:220px;padding-bottom:30px">
...
import RingChart from '../../components/calculator/RingChart'
import LoanCaculate from '../../components/calculator/LoanCaculate'
export default {
  components: {
    ButtonTab,
    ButtonTabItem,
